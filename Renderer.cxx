...
Renderer::Renderer(mat4 P, mat4 V) {
    ...
    modelVertexHandle = glGetAttribLocation(programID,"vertexPosition_modelspace");    
    //vertexColorHandle = program.getAttrib("vertexColor");
    textureSamplerHandle  = glGetUniformLocation(programID,"myTextureSampler");
    vertexUVHandle = glGetAttribLocation(programID,"vertexUV");
